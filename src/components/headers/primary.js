  ...
  return (
    <header className="px-2 pt-6 bg-primary01 w-screen overflow-hidden">
      ...
      >
        ...
        <div className="font-lato flex flex-row items-center my-2 ml-9 xl:ml-0 lg:ml-0 ms:ml-0 sm:ml-0">
          <div className="flex flex-row items-center">
            <img src={images.GlobeWhiteIcon} className="max-h-[20px]"/>
            <span className="text-neutrals01 ml-2">English USD $</span>
          </div>
          <button className="flex flex-row items-center ml-10">
            <img src={images.HelpWhiteIcon} className="max-h-[20px]"/>
            <span className="text-neutrals01 ml-2">FAQ</span>
          </button>
          <button className="flex flex-row items-center ml-10">
            <img src={images.AvatarBlueIcon} className="max-h-[20px]"/>
